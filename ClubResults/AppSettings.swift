...
struct GradeBackup: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case asksHeadCoach, asksAssistantCoach, asksTeamManager, asksRunner, asksGoalUmpire, asksTimeKeeper
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encode(asksTimeKeeper, forKey: .asksTimeKeeper)
    ...
    for backup in backups {
        ...
        resolved.append(
            Grade(
                ...
                asksTimeKeeper: backup.asksTimeKeeper,
